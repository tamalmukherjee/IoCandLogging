...
namespace WebRole1.NlogExtension
{
    public class NLogger : ILogger
    {
        ...
        private void WriteLog(string message, string userId, string subdomain, LogLevel level)
        {
            ...
            SetLogEventCustomProperties(logEvent, userId, subdomain);
            logger.Log(logEvent);
        }
        ...
        private static void SetLogEventCustomProperties(LogEventInfo logEvent, string userId, string subdomain)
        {
